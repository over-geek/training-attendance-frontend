  ...
  return (
      <section className="px-7 bg-gray-50 py-10 h-full">
        <div className="flex items-center gap-6 px-7 mb-14">
          <StatsCards statTitle="Upcoming Trainings" statScore={upcomingTrainingsScore}/>
          {/*<StatsCards iconName="work" statTitle="Avg Absents" statScore={0}/>*/}
          <StatsCards statTitle="Trainings this year" statScore={completedTrainingPerYearScore}/>
